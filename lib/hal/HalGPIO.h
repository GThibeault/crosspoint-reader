...
class HalGPIO {
 ...
 public:
  ...
  // Verify that the power button remains pressed until the specified time
  // since boot. Used after settings load to enforce long-press wake policy.
  bool verifyPowerButtonHeldUntil(uint16_t bootAgeMs);
