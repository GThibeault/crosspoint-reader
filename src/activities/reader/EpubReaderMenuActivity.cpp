...
EpubReaderMenuActivity::EpubReaderMenuActivity(GfxRenderer& renderer, MappedInputManager& mappedInput,
                                               ...
                                               const bool hasLinks, const bool hasBookmarks)
  ...
  buildMenuItems(menuItems, hasLinks, hasBookmarks);
  buildMenuRowItems();
}
...
void EpubReaderMenuActivity::buildMenuItems(std::vector<MenuItem>& items, bool hasLinks, bool hasBookmarks) {
  items.clear();
