...
void setup() {
  ...
  switch (wakeupReason) {
    case HalGPIO::WakeupReason::PowerButton:
      // The wake policy is independent of the short-press action used while the
      // device is already awake.
      if (SETTINGS.powerButtonWake != CrossPointSettings::POWER_BUTTON_WAKE::WAKE_SHORT_PRESS &&
          (!wakeHoldVerified ||
           !gpio.verifyPowerButtonHeldUntil(CrossPointSettings::POWER_BUTTON_LONG_PRESS_MS))) {
